 	...
 	for($i=0; $i<count($all_to_notify); $i++){
 		...
 		if(mysqli_num_rows($res) > 0){
 			...
 			$query =	"INSERT INTO wall_receipts " .
 						"(user_id, post_id, card_id, response_to, new) " .
 						"VALUES (" .
 							$all_to_notify[$i] . ", " .
 							$post_id . ", " .
 							$card_id . ", " .
